    ...
    return (
        <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r-2 border-[#191c1e] z-[60] flex flex-col py-8 gap-4 hidden md:flex shadow-[4px_0px_0px_0px_rgba(25,28,30,1)]">
            ...
            <div className="px-6 mb-4">
                <h1 className="font-extrabold text-2xl text-[#ba0029] tracking-tighter uppercase">
                    ANTI-KUDDUS
                </h1>
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-3 px-4 py-3 font-mono text-sm font-medium transition-all active:translate-x-1 ${
                                isActive 
                                ? 'bg-[#ba0029] text-white shadow-lg' 
            ...
            <div className="mt-auto px-6 space-y-4">
                {/* নতুন বাটন */}
                <button className="w-full bg-[#00696D] text-white py-3 font-bold font-mono text-xs tracking-wider transition-all hover:bg-[#005a5e]">
                    INITIATE PROTOCOL
                </button>
                
                {/* Settings & Logout */}
                <div className="flex flex-col gap-3 pt-2">
                    <button className="flex items-center gap-3 font-mono text-xs font-bold text-[#565e74] hover:text-[#191c1e]">
